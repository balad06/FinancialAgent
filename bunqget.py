...
for account in accounts:
    print(f"Account ID: {account.id_}, Description: {account.description}, Balance: {account.balance.value} {account.balance.currency}")
...
#
# Id: 2098200
monetary_account = MonetaryAccountBankApiObject.get(2108357).value
